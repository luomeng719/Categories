...
//                ILSLogInfo(@"debug", @"![WARNING][LIB:ALAssetsLibrary+CustomPhotoAlbum]: \
            ...
            // Create new assets album
                ...
                if (PHPhotoLibrary_class) {
                     ...
                     *
                     ...
                     if (!success) {
                     ILSLogInfo(@"debug", @"Error creating album: %@", error);
                     }
                     }];
...
//        ILSLogInfo(@"debug", @"%s: %@", __PRETTY_FUNCTION__, [error localizedDescription]);
